...
GLuint				compile_shaders(const char *vert_fpath,
									const char *frag_fpath);
void				load_this(t_scop_object *entry);
GLuint				texture_by_index(int i);
void				load_textures(void);
void				handle_command(t_sdl *sdl, t_scop_object *entry,
												t_scop_object *skybox);
void				draw(t_sdl *sdl, t_scop_object *entry,
									t_scop_object *skybox);
